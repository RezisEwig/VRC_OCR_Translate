...
from .text import normalize_text, source_language_description
...
class TranslateGemmaTranslator:
    ...
    def translate(self, source_text: str) -> str:
        ...
        prompt = build_translation_prompt(source, self._config.source_languages)
        started = time.monotonic()
        ...
        self._cache.put(source, translated)
        LOGGER.info(
...
def build_translation_prompt(
    ...
    return (
        "<start_of_turn>user\n"
        f"You are a professional {source_description} to Korean translator. "
        ...
        f"commentary. Translate the following {source_description} text into Korean:\n\n\n"
